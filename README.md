...
If you have any questions, suggestions, or improvements, please feel free to contact via:

邮箱/Email: wli87165@163.com
...
安全性 / Security
代码审查：作为用户，您有责任在使用前审查代码的安全性。请勿直接在不了解代码行为的环境中运行从互联网下载的脚本。
Code review: As a user, you are responsible for reviewing the security of the code before use. Do not directly run scripts downloaded from the internet in environments where you do not understand their behavior.

数据安全：如果代码会处理您的敏感或私有数据，请确保在隔离和安全的环境中运行，并考虑进行数据脱敏。
Data security: If the code will process your sensitive or private data, please ensure it runs in an isolated and secure environment, and consider data anonymization.
